function Agregar(){
  var totalAsistentes=0;
    ...
    "&totalP=" + totalAsistentes +
    "&totalA=" + totalAusentes
    );
    alert("La asistencia fue tomada con éxito.\nTotal de Alumnos PRESENTE: "+totalAsistentes+"\nTotal del Alumnos AUSENTES: "+totalAusentes);
  };
